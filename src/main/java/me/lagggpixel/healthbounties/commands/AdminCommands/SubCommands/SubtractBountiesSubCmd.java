...
public class SubtractBountiesSubCmd extends SubCommand {
    @Override
    public @NotNull String getCommand() {
        return "subtractbounties";
    }
    ...
    public @NotNull String getPermission() {
        return "healthbounties.admin.subtractbounties";
    }

    @Override
    public @NotNull String getUsage() {
        return "/%command% subtractbounties <player> <amount>";
    }
    ...
    public void execute(CommandSender commandSender, String command, String[] args) {
        ...
        BountyManager.removeBounty(targetUuid, amount);
        if (target.isOnline()) {
