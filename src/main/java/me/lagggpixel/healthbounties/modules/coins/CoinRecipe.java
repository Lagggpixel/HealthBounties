...
public class CoinRecipe {

    private static final String fileName = "coins_recipe.yml";
    ...
    public static void registerCoinRecipe() {
        ...
        itemMeta.getPersistentDataContainer().set(CoinsManager.coinItemNameSpacedKey, PersistentDataType.STRING, "coinItem");
        ...
        ShapedRecipe recipe = new ShapedRecipe(CoinsManager.coinRecipeNameSpacedKey, itemStack);
